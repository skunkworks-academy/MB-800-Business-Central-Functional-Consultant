---
lab:
  title: 'Lab 04: Migrate master data to a new company'
  module: 'Migrate data to Business Central'
  duration: 30 minutes
  level: 200
  islab: true
---

## Exercise 4: Migrate master data to a new company
...
## Task 3: Import and apply datato an existing company
...
1. Import and apply a predefined package.
   ...
   3. Select the file **MB800\_Lab\_2.3\_EVALUATION.xlsx**, and then select **Open**.
   4. Select **Import** to confirm.
   5. Select on **EVALUATION**.
   6. Select**Package,Apply Package**.
   7. **If you get a message:This configuration package contains dimensions. This can lead to inconsistencies. Do you want to continue? Click Yes.**